import { ContactsFormErrors, OrderFormErrors, IAct, IContactInfo, IGallery, IOrder, IOrderF, IPage, IProd, IState } from '../../types';
...
export class Card<T extends IProd | {}> extends Component<T | IProd> {
  ...
  set image(value: string) { this.setText(this._image, value) };
